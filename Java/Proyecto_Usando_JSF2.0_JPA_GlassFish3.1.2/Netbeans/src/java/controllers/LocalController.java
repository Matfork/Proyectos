...
public class LocalController implements Serializable {
    ...
    @EJB
    private session.LocalFacade ejbFacade;
    ...
    public static class LocalControllerConverter implements Converter {
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Local) {
                ...
                throw new IllegalArgumentException("object " + object + " is of type " + object.getClass().getName() + "; expected type: " + LocalController.class.getName());
            }
        }
    }
}
