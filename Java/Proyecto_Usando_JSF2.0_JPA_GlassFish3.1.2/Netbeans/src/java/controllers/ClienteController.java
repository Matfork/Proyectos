...
public class ClienteController implements Serializable {
    ...
    @EJB
    private session.ClienteProceduresFacade clienteProceduresFacade;
    ...
    public String create() {
        try {
           // if(current.getIdcliente().length()<6)
           //    throw new Exception("Debe Ser mayor de 5");
            
            //getFacade().create(current);
            clienteProceduresFacade.p_insert_cliente(current);
